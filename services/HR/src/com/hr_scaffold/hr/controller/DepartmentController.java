...
import com.hr_scaffold.hr.service.DepartmentService;

/**
 * Controller object for domain model class Department.
 * @see Department
 */
@RestController("HR.DepartmentController")
...
public class DepartmentController {
    ...
    @Autowired
    @Qualifier("HR.DepartmentService")
    ...
    public Department editDepartment(@PathVariable("id") Integer id, @RequestBody Department department) throws EntityNotFoundException {
        LOGGER.debug("Editing Department with id: {}", department.getDepid());
    ...
    public Page<Employees> findAssociatedEmployeeses(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return departmentService.findAssociatedEmployeeses(id, pageable);
    }
