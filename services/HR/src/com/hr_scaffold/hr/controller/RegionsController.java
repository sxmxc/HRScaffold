...
import com.hr_scaffold.hr.service.RegionsService;
...
public class RegionsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Regions getRegions(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Regions editRegions(@PathVariable("id") Integer id, @RequestBody Regions regions) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteRegions(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    public Page<Employees> findAssociatedEmployeeses(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return regionsService.findAssociatedEmployeeses(id, pageable);
    }
    ...
    public Page<Users> findAssociatedUserses(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return regionsService.findAssociatedUserses(id, pageable);
    }
