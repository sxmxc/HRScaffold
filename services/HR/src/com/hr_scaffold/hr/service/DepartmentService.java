...
public interface DepartmentService {
    ...
    /*
     * Returns the associated employeeses for given Department id.
     *
     * @param depid value of depid; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<Employees> findAssociatedEmployeeses(Integer depid, Pageable pageable);
